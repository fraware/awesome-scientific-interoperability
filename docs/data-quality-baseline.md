...
**As of:** 2026-08-02
**Generated by:** `python scripts/audit_data_quality.py --as-of 2026-08-02 --write-baseline docs/data-quality-baseline.json`
...
```bash
python scripts/audit_data_quality.py --as-of 2026-08-02 --json-report data-quality-audit.json
```
...
```bash
python scripts/audit_data_quality.py --as-of 2026-08-02 --write-baseline docs/data-quality-baseline.json
```
