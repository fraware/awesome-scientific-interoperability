...
| Registry sizes | 304 references, 69 stewards |
...
|---|---:|---|
| Unsupported `multiple-independent` | 0 | Enrich with ≥2 direct implementation/adoption/registry/interop refs, or downgrade status |
